...
const CalculateRoute = (start,finish)=>{
    return(uniquePairs([graph.DijkstraAlternatives1(start, finish),graph.DijkstraAlternatives2(start, finish),graph.DijkstraAlternatives3(start, finish),graph.DijkstraAlternatives4(start, finish),graph.DijkstraAlternatives5(start, finish),graph.DijkstraFastest(start, finish)]))
}
